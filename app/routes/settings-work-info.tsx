    ...
    <div className="mt-2 inline-flex items-center px-4 py-1 rounded-full border border-green-400 bg-green-50 text-green-700 text-sm font-semibold">
      ...
      <div className="mt-6 grid grid-cols-[2fr_1fr] gap-6 pb-12">
        ...
        <div className="space-y-6">
          {/* Experience */}
          <div className="bg-white rounded-xl shadow border p-6 relative h-[280px] flex flex-col items-center justify-center text-center">
          ...
          <div className="grid grid-cols-3 gap-6">
            {/* LinkedIn */}
            <div className="col-span-2 bg-white rounded-xl shadow border p-6 relative h-[150px]">
            ...
            {/* Employment */}
            <div className="bg-white rounded-xl shadow border p-6 relative h-[150px]">
          ...
          {/* Years of experience */}
          <div className="bg-white rounded-xl shadow border p-6 h-[90px] flex flex-col justify-center">
          ...
          <div className="grid grid-cols-3 gap-6">
            {/* Experience Tech */}
            <div className="bg-white rounded-xl shadow border p-6 h-[120px]">
            ...
            {/* Career goal */}
            <div className="bg-white rounded-xl shadow border p-6 relative h-[120px]">
