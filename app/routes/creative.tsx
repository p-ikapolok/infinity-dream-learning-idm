...
export function meta({}: Route.MetaArgs) {
  return [
    { title: "Creative Programs | Infinity Dream Learning" },
    {
      name: "description",
      content: "Unlock your creative potential with our UI/UX, animation, and digital media tracks.",
    },
  ];
}
  ...
  const programs = [
    {
      ...
      description: "Learn user research, wireframing, and high-fidelity prototyping using Figma.",
      image: "https://images.unsplash.com/photo-1561070791-2526d30994b5?q=80&w=800",
      level: "Beginner",
    },
    {
      title: "Advanced 3D Animation",
      description: "Bring characters to life with Blender and Maya for games and cinematic media.",
      image: "https://images.unsplash.com/photo-1618005182384-a83a8bd57fbe?q=80&w=800",
      level: "Advanced",
    },
    {
      title: "Digital Marketing & Brand Strategy",
      description: "Master SEO, content strategy, and paid acquisition to grow modern brands.",
      image: "https://images.unsplash.com/photo-1432888498266-38ffec3eaf0a?q=80&w=800",
      level: "Intermediate",
    },
    {
      title: "Video Production & Editing",
      description: "Shoot, cut, and color-grade professional video content using Premiere Pro and DaVinci Resolve.",
    ...
    <div className={darkMode ? "dark min-h-screen" : "min-h-screen"}>
      ...
      <div className="bg-gray-50 text-gray-900 dark:bg-gray-950 dark:text-gray-100 transition-colors duration-500 font-sans pb-10">
        ...
        <div
          ...
          style={{
            backgroundImage: "url('https://images.unsplash.com/photo-1558655146-d09347e92766?q=80&w=2064')",
          ...
          <div className="relative z-10">
            ...
            <section className="py-24 px-6 text-center">
              <div className="max-w-4xl mx-auto">
                <span className="text-pink-400 font-bold tracking-widest uppercase text-sm mb-4 block">Track Overview</span>
                <h1 className="text-5xl md:text-6xl font-extrabold leading-tight tracking-tight mb-6">
                  Design the <span className="text-pink-400">extraordinary.</span>
                </h1>
                <p className="mt-6 text-xl text-gray-300 leading-relaxed max-w-2xl mx-auto">
                  Combine artistic vision with industry-standard tools to craft stunning digital experiences.
                </p>
              </div>
            </section>
          </div>
        ...
        <section className="max-w-7xl mx-auto px-6 mb-24">
          <div className="flex justify-between items-end mb-10 border-b border-gray-200 dark:border-gray-800 pb-4">
            <h2 className="text-3xl font-bold">Creative Programs</h2>
            ...
            {programs.map((prog, idx) => (
              <div key={idx} className="bg-white dark:bg-gray-900 rounded-2xl overflow-hidden shadow-lg border border-gray-100 dark:border-gray-800 group flex flex-col h-full">
                ...
                <div className="p-6 flex flex-col flex-grow">
                  ...
                  <h3 className="text-xl font-bold mb-3 group-hover:text-pink-600 dark:group-hover:text-pink-400 transition-colors">{prog.title}</h3>
                  <p className="text-gray-600 dark:text-gray-400 text-sm leading-relaxed mb-6 flex-grow">{prog.description}</p>
                  {/* Funnels to pricing */}
                  <Link to="/pricing" className="block w-full text-center py-3 bg-gray-50 dark:bg-gray-950 text-pink-600 dark:text-pink-400 font-semibold rounded-xl border border-gray-200 dark:border-gray-800 hover:bg-pink-600 hover:text-white dark:hover:bg-pink-600 dark:hover:text-white dark:hover:border-pink-600 transition-all">
                    View Details
                  </Link>
                </div>
              </div>
