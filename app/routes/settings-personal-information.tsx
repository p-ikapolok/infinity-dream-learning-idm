...
export default function PersonalInformation() {
  return (
    <Layout>
      ...
      {/* LOCKED GRID EXACT LIKE SCREENSHOT */}
      <div className="mt-6 grid grid-cols-3 grid-rows-[220px_140px_140px_260px] gap-6 pb-12">
        {/* About Me */}
        <div className="col-start-1 col-span-3 row-start-1 bg-white rounded-xl shadow border p-6 relative">
        ...
        {/* Languages */}
        <div className="col-start-1 row-start-2 bg-white rounded-xl shadow border p-6 relative">
        ...
        {/* Phone */}
        <div className="col-start-2 row-start-2 bg-white rounded-xl shadow border p-6 relative">
        ...
        {/* Social */}
        <div className="col-start-3 row-start-2 bg-white rounded-xl shadow border p-6 relative">
        ...
        {/* Interests */}
        <div className="col-start-1 col-span-2 row-start-3 bg-white rounded-xl shadow border p-6 relative">
        ...
        {/* Location */}
        <div className="col-start-3 row-start-3 bg-white rounded-xl shadow border p-6 relative">
        ...
        <div className="col-start-1 col-span-3 row-start-4 bg-white rounded-xl shadow border p-6 h-[260px]">
