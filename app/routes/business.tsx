...
export function meta({}: Route.MetaArgs) {
  return [
    { title: "Entrepreneurship Programs | Infinity Dream Learning" },
    {
      name: "description",
      content: "Learn how to launch startups, raise capital, and manage products with our business tracks.",
    },
  ];
}
  ...
  const programs = [
    {
      ...
      description: "From ideation to MVP. Learn how to validate your market and build your first product iteration.",
      image: "https://images.unsplash.com/photo-1556761175-5973dc0f32e7?q=80&w=800",
      level: "Beginner",
    },
    {
      title: "Venture Capital & Fundraising",
      description: "Understand term sheets, cap tables, and how to successfully pitch angel investors and VCs.",
      image: "https://images.unsplash.com/photo-1554224155-8d04cb21cd6c?q=80&w=800",
      level: "Advanced",
    },
    {
      title: "Agile Product Management",
      description: "Master user stories, sprint planning, and cross-functional leadership to ship better software.",
      image: "https://images.unsplash.com/photo-1531482615713-2afd69097998?q=80&w=800",
      level: "Intermediate",
    },
    {
      title: "Growth Hacking & Analytics",
      description: "Scale your user base rapidly using data-driven experimentation and viral marketing loops.",
      ...
      <div className="bg-gray-50 text-gray-900 dark:bg-gray-950 dark:text-gray-100 transition-colors duration-500 font-sans pb-10">
          ...
          <div className="relative z-10">
            ...
            <section className="py-24 px-6 text-center">
              <div className="max-w-4xl mx-auto">
                <span className="text-green-400 font-bold tracking-widest uppercase text-sm mb-4 block">Track Overview</span>
                <h1 className="text-5xl md:text-6xl font-extrabold leading-tight tracking-tight mb-6">
                  Launch your <span className="text-green-400">vision.</span>
                </h1>
                <p className="mt-6 text-xl text-gray-300 leading-relaxed max-w-2xl mx-auto">
                  Equip yourself with the strategic frameworks and leadership skills needed to scale modern businesses.
                </p>
              </div>
            </section>
          </div>
        ...
        <section className="max-w-7xl mx-auto px-6 mb-24">
          <div className="flex justify-between items-end mb-10 border-b border-gray-200 dark:border-gray-800 pb-4">
            <h2 className="text-3xl font-bold">Entrepreneurship Programs</h2>
            ...
            {programs.map((prog, idx) => (
              <div key={idx} className="bg-white dark:bg-gray-900 rounded-2xl overflow-hidden shadow-lg border border-gray-100 dark:border-gray-800 group flex flex-col h-full">
                ...
                <div className="p-6 flex flex-col flex-grow">
                  ...
                  <h3 className="text-xl font-bold mb-3 group-hover:text-green-600 dark:group-hover:text-green-400 transition-colors">{prog.title}</h3>
                  <p className="text-gray-600 dark:text-gray-400 text-sm leading-relaxed mb-6 flex-grow">{prog.description}</p>
                  {/* Funnels to pricing */}
                  <Link to="/pricing" className="block w-full text-center py-3 bg-gray-50 dark:bg-gray-950 text-green-600 dark:text-green-400 font-semibold rounded-xl border border-gray-200 dark:border-gray-800 hover:bg-green-600 hover:text-white dark:hover:bg-green-600 dark:hover:text-white dark:hover:border-green-600 transition-all">
                    View Details
                  </Link>
                </div>
              </div>
