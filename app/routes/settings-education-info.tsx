    ...
    <div className="mt-2 inline-flex items-center px-4 py-1 rounded-full border border-green-400 bg-green-50 text-green-700 text-sm font-semibold">
      ...
      <div className="mt-6 grid grid-cols-[2fr_1fr] gap-6 pb-12">
        ...
        <div className="space-y-6">
          {/* Education Card */}
          <div className="bg-white rounded-xl shadow border p-6 relative h-[320px] flex flex-col items-center justify-center text-center">
          ...
          <div className="grid grid-cols-2 gap-6">
            ...
            <div className="bg-white rounded-xl shadow border p-6 h-[180px]">
            ...
            {/* Achievement */}
            <div className="bg-white rounded-xl shadow border p-6 relative h-[180px]">
