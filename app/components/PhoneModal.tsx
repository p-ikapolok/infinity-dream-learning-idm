export default function PhoneModal({ onClose }: any) {
  return (
    <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50">
      <div className="bg-white w-[600px] rounded-xl p-6">
        ...
        <div className="mb-4">
          ...
          <input className="w-full border p-2 rounded mt-1" defaultValue="+254739762594" />
        </div>

        <div className="mb-4">
          <label className="text-sm">WhatsApp Number*</label>
          <input className="w-full border p-2 rounded mt-1" defaultValue="+254740748621" />
        </div>
