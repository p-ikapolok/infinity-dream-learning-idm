  ...
  return (
    <div className="fixed inset-0 bg-black/30 flex items-center justify-center">
      <div className="w-[620px] bg-white rounded-[16px] px-[24px] py-[20px] shadow-xl space-y-[12px] relative">
        ...
        <select className="w-full h-[44px] border rounded-[10px] px-[12px]" />

        <div className="grid grid-cols-2 gap-[12px]">
          <select className="h-[44px] border rounded-[10px] px-[12px]" />
          <select className="h-[44px] border rounded-[10px] px-[12px]" />
        </div>

        <input className="w-full h-[44px] border rounded-[10px] px-[12px]" />
